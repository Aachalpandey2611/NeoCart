    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div>
            <h1 className="text-4xl font-black mb-2">
              Our <span className="gradient-text">Future Tech</span>
            </h1>
            <p className="text-gray-400 font-medium">
              Explore the most advanced devices in the galaxy.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <button
                type="submit"
                className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-gray-400 group-hover:text-white transition-colors"
              >
        ...
        <div className="flex flex-col md:flex-row gap-8">
          {/* Sidebar Filters */}
          <div
            className={`w-full md:w-64 glass-dark rounded-3xl p-6 border border-white/10 md:sticky md:top-24 h-max transition-all duration-300 ${isFilterOpen ? "block" : "hidden md:block"}`}
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                className="text-xs text-purple-400 hover:text-purple-300 uppercase font-bold tracking-wider"
              >
                Clear
              </button>
            </div>
